...
public class ResultEntity {
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> ok(ResultCode resultCode) {
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> ok(T data, Paginate paginate) {
        return new ResponseEntity<>(
                createResultDto(ResultCode.SUCCESS, null, data,
                        paginate),
                HttpStatus.OK
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> fail(ResultCode resultCode) {
        return new ResponseEntity<>(
                createResultDto(resultCode, null, null, null),
                HttpStatus.OK
        );
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> fail(ResultCode resultCode, String message) {
        return new ResponseEntity<>(
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> created(String location) {
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> created(String location, T data) {
        HttpHeaders responseHeaders = new HttpHeaders();
        responseHeaders.setLocation(URI.create(location));
        return new ResponseEntity<>(
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> badRequest(ResultCode resultCode, String message) {
        return new ResponseEntity<>(
                createResultDto(resultCode, message, null, null),
     ...
     */
    public static <T> ResponseEntity<ResultDto<T>> notFound(ResultCode resultCode, String message) {
        return new ResponseEntity<>(
                createResultDto(resultCode, message, null, null),
    ...
    private static <T> ResultDto<T> createResultDto(
            ResultCode resultCode, String message, T data, Paginate paginate) {
